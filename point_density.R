...
f_pointdensity <- function(chunk, hmin, hmax){
  ...
  filtered_las = filter_poi(nlas, Z>=hmin, Z<=hmax)
...
writeRaster(pt_den, paste0("D:\\PROJECT_TREES\\MAUNGATAUTARI\\R_OUTPUT\\DENSITYMAP\\DENSITY",'_',hMin*100,'CM_', hMax*100,'CM.tif' ), overwrite=TRUE)
